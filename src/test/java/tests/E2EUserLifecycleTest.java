...
public class E2EUserLifecycleTest extends BaseTest {

    @Test(description = "Usuário Criado Com Sucesso")
 ...
 @Test (description = "Validar que o usuário não pode ser criado sem um nome")
...
@Test (description = "Validar que o usuário não pode ser criado sem CPF")
